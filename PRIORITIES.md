...
1. Write the Phase 3 completion audit (`docs/audits/`), gate by gate
   against `ROADMAP.md`'s exit condition for "Elastic Re-Scheduling &
   Ad-hoc Events"; remove the phase from `ROADMAP.md`; update
   `CHANGELOG.md`; commit.
