...
CREATE TABLE "new_TrackableItem" (
    ...
    "unitWeightOverrides" TEXT NOT NULL DEFAULT '{}',
    "currentUnitSessionsCompleted" INTEGER NOT NULL DEFAULT 0,
    "tags" TEXT NOT NULL DEFAULT '[]',
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL
);
INSERT INTO "new_TrackableItem" ("createdAt", "currentUnitSessionsCompleted", "estimatedDays", "id", "priority", "status", "tags", "targetDate", "title", "type", "unitCount", "unitWeightMultiplier", "unitsCompleted", "updatedAt") SELECT "createdAt", "currentUnitSessionsCompleted", "estimatedDays", "id", "priority", "status", "tags", "targetDate", "title", "type", "unitCount", "unitWeightMultiplier", "unitsCompleted", "updatedAt" FROM "TrackableItem";
