...
INSERT INTO "new_TrackableItem" ("createdAt", "estimatedDays", "id", "priority", "status", "tags", "title", "type", "unitCount", "unitsCompleted", "updatedAt") SELECT "createdAt", "estimatedDays", "id", "priority", "status", "tags", "title", "type", "unitCount", "unitsCompleted", "updatedAt" FROM "TrackableItem";
